        ...
        implements PvChangeListener
{
    ...
    Collection getPreferredItems(PvList pvs)
    {
        ...
        Set<String> pidsToShow = prefs.getStringSet("data_items" /*SettingsActivity.KEY_DATA_ITEMS*/,
        ...
        try
        {
                    ...
                    )
            {
                        ...
                        && cnv instanceof NumericConversion)
                {
                    ...
                    pb.getProgressDrawable().setColorFilter(0xFFFF0000/*ChartActivity.getItemColor(pid)*/, PorterDuff.Mode.SRC_IN);
