...
public abstract class CommService {
    ...
    synchronized void setState(STATE state)
    {
        ...
        mHandler.obtainMessage(Bluetooth.MESSAGE_STATE_CHANGE, state).sendToTarget();
    }
    ...
    void connectionFailed()
    {
        ...
        bundle.putString(Bluetooth.TOAST, mContext.getString(R.string.unabletoconnect));
        msg.setData(bundle);
    ...
    void connectionLost()
    {
        ...
        Message msg = mHandler.obtainMessage(Bluetooth.MESSAGE_TOAST);
        Bundle bundle = new Bundle();
        bundle.putString(Bluetooth.TOAST, mContext.getString(R.string.connectionlost));
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    void connectionEstablished(String deviceName)
    {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Bluetooth.DEVICE_NAME, deviceName);
        msg.setData(bundle);
        mHandler.sendMessage(msg);
